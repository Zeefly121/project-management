export const dataGridClassNames =
  "border border-gray-200 bg-white shadow dark:border-dark-stroke dark:bg-dark-secondary dark:text-gray-200";
...
// export const primeTableStyles = {
//   column: {
//     headerCell: {className: 'dark:bg-[#1d1f21] dark:border-[#2d3135]'},
//     bodyCell: {className: 'font-semibold dark:border-[#2d3135]'},
//   },
//   bodyRow: ({context}) => ({className: context.stripedRows ? (context.index % 2 === 0 ? 'bg-white dark:bg-slate-900' : 'bg-blue-50/50 dark:bg-slate-950') : '',})
// }
...
//     datatable: {
//         root: ({ props }) => ({
//             className: classNames('relative dark:bg-slate-900', {
...
//         bodyrow: ({ context }) => ({
//             className: classNames(
//                 context.selected ? 'bg-blue-50 text-blue-700 dark:bg-blue-300' : 'bg-white text-gray-600 dark:bg-slate-900',
//                 context.stripedRows ? (context.index % 2 === 0 ? 'bg-white text-gray-600 dark:bg-slate-900' : 'bg-blue-50/50 text-gray-600 dark:bg-slate-950') : '',
//                 'transition duration-200',
